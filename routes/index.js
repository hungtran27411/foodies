...
router.get('/oauth2callback', passport.authenticate(
  'google',
  {
    successRedirect : '/foodies', // UPDATE THIS, where do you want the client to go after you login 
    failureRedirect : '/foodies' //  UPDATE THIS, where do you want the client to go if login fails
  }
));
